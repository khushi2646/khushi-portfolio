  ...
  return (
    <Link
      href={{
        ...
        query: { tab: "digital-products" }, // Passing query parameter to indicate the tab
      }}
          ...
          <div className="w-1/2 h-fit bg-grey-100 rounded-xl p-3 space-y-3">
            <div className="bg-white px-2 py-4 rounded-lg space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="font-semibold text-md2 font-aileron text-grey-500">
                  2024
                </div>
              </div>
              <div className="font-aileron font-normal text-md text-grey-500">
                Developing an innovative digital asset SaaS platform, enhancing
                transaction efficiency for financial service providers and
                corporates.
              </div>
            </div>
